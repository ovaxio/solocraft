...
| Command | When to use |
|---|---|
| `/sc-research <idea>` | Market and competitive research before implementing a feature or launching a SaaS project. Run before `/sc` when the feature has a product angle. |
